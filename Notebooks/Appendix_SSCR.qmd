...
: Comments on the size (number of parameters) and accessibility for the language models we tested.
...
### Alternative implementation and error mitigation strategies
...
annotators <- c("human_r1", "human_r2", names(relevance_list)[-c(1:4, 9)])
...
annotator_names <- c("Human (Round 1)", "Human (Round 2)", "Naive Bayes", "BERT", "DeBERTa",
                     "Llama zero-shot", "Claude zero-shot", "GPT-OSS zero-shot")
...
### Manual coding {#human-framing-codebook}
...
### Alternative implementation/error mitigation strategies
...
names(models) <- c("Llama 3.1-8B-Instruct (8-bit quantized) with LLM-as-judge",
                   "Llama 3.1-8B-Instruct (8-bit quantized) with human-in-the-loop",
                   "Llama 3.1-8B-Instruct (8-bit quantized) with decision trees on decomposed task",
                   "Llama 3.1-8B-Instruct (8-bit quantized) with verbalized confidence scores",
