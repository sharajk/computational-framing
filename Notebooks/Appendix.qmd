---
title: "Computational news frame analysis revisited:
on LLMs and textual annotation"
...
# 
# #LOAD FRAMES
# llama_frames <- read.csv(here::here("Codebook/LLM", "llama_frames.csv"), check.names = F, row.names = NULL)
# 
# df_frames <- cbind("ID" = c(1:nrow(llama_frames)), llama_frames)
# df_frames <- df_frames[,c("ID", "Name", "Description","Example")] #add ID
# 
# knitr::kable(df_frames, align = 'c', escape = F,
#              caption = "Frames identified by Llama through inductive thematic analysis") %>%
